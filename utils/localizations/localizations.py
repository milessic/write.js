...
class Localizations:
    def __init__(
        self, default_lang: str = "en", custom_path_to_translations: str | None = None
    ):
        self._translations = {}
        self._default_lang = default_lang
        if custom_path_to_translations is None:
            self._path_to_translations = os.path.join(
...
observer.schedule(
    event_handler, path=localizations._path_to_translations, recursive=False
)
observer.start()
